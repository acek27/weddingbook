                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input style="text-transform: uppercase" type="text" name="nama" value="{{old('nama')}}" class="form-control date"
                ...
                <div class="row clearfix">
                    <div class="col-sm-12">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input style="text-transform: capitalize" value="{{old('alamat')}}" type="text" name="alamat" class="form-control date"
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" name="uang" class="form-control date" placeholder="Inputkan Uang">
                            </div>
                            @if ($errors->any())
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" name="beras" class="form-control date" placeholder="Inputkan Beras">
                            </div>
                            @if ($errors->any())
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <input type="text" name="gula" class="form-control date" placeholder="Inputkan Gula">
                            </div>
                            @if ($errors->any())
